      ...
      <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="thumbnail">
                        <h3 class="h3 text-center text-info">Add a Legend</h3>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="thumbnail">
                        ...
                        <form action="<?=  base_url()?>index.php/cpanel/legend/" method="post" enctype="multipart/form-data">
                            <p></p>
                            <div class="row">
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    <input name="player_position" type="text" required class="form-control" placeholder="player postion">
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <input name="appearances" type="text" required class="form-control" placeholder="Appearances">
                                </div>
                                ...
                                <div class="col-md-4">
                                    <input name="joined_on" type="text" required class="form-control" placeholder="Joined club on">
                                </div>
                            </div>
                            <p></p>
                            <div class="row">
                                <div class="col-md-6">
                                    <input name="last_game_date" type="text" required class="form-control" placeholder="Last played On">
                                </div>
                                
                                <div class="col-md-6">
                                    <input name="legend_image" type="file" required class="form-control" placeholder="Image">
                                </div>
                            </div>
                            <p></p>
                            <div class="row">
